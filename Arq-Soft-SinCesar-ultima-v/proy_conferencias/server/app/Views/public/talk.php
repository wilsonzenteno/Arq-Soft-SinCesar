...
<style>
  ...
  /* Theme-aware KPI tiles */
  .kpi > div { border-radius:10px; padding:10px; }
  [data-theme="light"] .kpi > div, .kpi > div { background:#ffffff; border:1px solid #e5e7eb; }
  [data-theme="dark"] .kpi > div { background:#0b1220; border:1px solid #1f2937; }
  @media (max-width: 720px){ .kpi { grid-template-columns: 1fr 1fr; } }
  .cnt { display:inline-block; min-width: 1.3em; text-align:center; }
  .muted { color: var(--muted); font-size:12px; }
  /* badge hereda del global; solo aseguramos espaciado */
...
(async () => {
  ...
  function render(){
    ...
    initOptimisticLikes('#talkBox');            // <<<< aquí activamos likes optimistas
