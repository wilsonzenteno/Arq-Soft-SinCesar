...
<style>
  .pill{ border-radius:9999px;padding:4px 10px; display:inline-flex; gap:6px; align-items:center;}
  ...
  .notice{ border-radius:10px;padding:10px;margin-top:10px; }
  [data-theme="light"] .notice, .notice{ background:#fff7ed; border:1px solid #fde68a; color:#7c2d12; }
  [data-theme="dark"] .notice{ background:#0b1220; border:1px solid #1f2937; color:#ffedd5; }
  .desc{ margin:12px 0; line-height:1.45; }
  .hero h2{ margin:0; }
  .btn.ghost{ background:transparent; border:1px dashed #d1d5db; }
  [data-theme="dark"] .btn.ghost{ border-color:#374151; }
