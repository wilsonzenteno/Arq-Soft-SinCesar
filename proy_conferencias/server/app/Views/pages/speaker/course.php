...
(function(){
  ...
  async function loadCourse(){
    try {
      const mine = await api('/speaker.courses.mine','GET');
    ...
    } catch (e) { console.warn('speaker.courses.mine falló:', e?.message || e); }

    const st = await api('/speaker.course.stats', { id }, 'GET');
